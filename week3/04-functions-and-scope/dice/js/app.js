...
function rollDice() {
  ...
  var firstDie = document.getElementById("first-die");
	...
	firstDie.className = "dice-" + randomNumber1;
	secondDie.className = "dice-" + randomNumber2;
}
...
// 	}
// 	function dice1 () {
// 		document.getElementById("first-die").className = "dice-"+randomNumber;
// 		randomNumber();
// 	};
// 	function dice2 () {
// 		document.getElementById("second-die").className = "dice-"+randomNumber;
// 		randomNumber();
// 	};
//
// 	dice1();
